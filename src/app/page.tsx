...
const faqs = [
  {
    ...
    answer:
      "Boost your energy naturally and stay active throughout the day with keto-friendly products.",
  ...
  },
  {
    ...
    answer:
      "Keto helps your body burn fat more effectively, supporting sustainable weight loss.",
  ...
  },
  {
    ...
    answer:
      "Discover delicious low-carb recipes and snacks that make keto both fun and flavorful.",
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="text-sm text-gray-600 mb-2">
              + An additional <span className="font-bold">10% OFF</span> when
              you subscribe
            </p>
      ...
      <section className="bg-white py-16 px-6">
        <h1 className="text-5xl font-extrabold text-black text-center mb-12">
          Shop by Category
        </h1>
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {categories.map((cat, idx) => (
            <div
              key={idx}
              className="rounded-2xl p-6 flex flex-col md:flex-row justify-between items-center"
            ...
            >
              ...
              <div className="max-w-sm">
                ...
                <button className="bg-black text-white px-5 py-2 rounded-full font-bold hover:bg-gray-800 transition">
                  SHOP NOW
                </button>
              </div>
              {/* Image */}
      ...
      <section className="bg-gray-50 py-16 px-6">
        <h1 className="text-5xl font-extrabold text-black text-center mb-4">
          Featured Products
        </h1>
        <p className="text-center text-gray-600 mb-12">
          Discover our best-selling products, trusted by thousands of keto
          customers.
        </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {featuredProducts.map((product, idx) => (
            ...
            >
              <span className="px-3 py-1 mb-4 text-xs font-bold text-green-600 border border-green-600 rounded-full">
                {product.category}
              </span>
              <Image
                src={product.img}
              ...
              <button className="mt-4 bg-black text-white px-6 py-2 rounded-full font-bold hover:bg-gray-800 transition">
                ADD TO CART
              </button>
            </div>
          ))}
        ...
        <div className="flex justify-center mt-12">
          <button className="border-2 border-black text-black px-8 py-3 rounded-full font-bold flex items-center hover:bg-black hover:text-white transition">
            SHOP ALL PRODUCTS
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/images/discober-bundle-bg-scaled1-2048x657.jpg')",
        }}
      >
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Right FAQ */}
          <div>
            <h2 className="text-4xl text-black font-extrabold mb-8">
              Learn about Keto
            </h2>
            <div className="space-y-6">
              {faqs.map((faq) => (
                ...
                >
                  ...
                  {openFAQ === faq.id && (
                    <p className="mt-3 text-black text-sm">{faq.answer}</p>
                  )}
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-800 mb-6">
              <span className="font-extrabold text-3xl">95%</span> of people say that Perfect Keto helps them stay consistent on a keto diet
            </p>
            <p className="text-lg text-gray-800 mb-6">
              <span className="font-extrabold text-3xl">70%</span> of people report lower sugar cravings after starting a keto diet with Perfect Keto products
            </p>
            <p className="text-lg text-gray-800 mb-8">
              <span className="font-extrabold text-3xl">64%</span> of people report their clothes fitting better after a keto diet with Perfect Keto products
            </p>
            <a href="#"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="relative">
                <Image src="/images/c1.jpg" alt="Before After 1" width={400} height={300} className="w-full h-64 object-cover" />
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-gray-900">Nisha’s Story</h3>
                <p className="text-gray-700 mb-3">“It is mind-blowing the impact keto has on mental health.”</p>
                <a href="#" className="text-green-600 font-semibold hover:underline flex items-center gap-1">
                  Read more <span>→</span>
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="relative">
                <Image src="/images/c2.png" alt="Before After 2" width={400} height={300} className="w-full h-64 object-cover" />
                <div className="absolute bottom-0 left-0 right-0 flex justify-between text-white text-xs font-bold bg-gradient-to-t from-black/80 to-transparent px-3 py-1">
                  <span>BEFORE</span>
                  <span>AFTER</span>
                </div>
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-gray-900">Leandrea’s Story</h3>
                <p className="text-gray-700 mb-3">“Life Is Too Short to be Anything but Happy.”</p>
                <a href="#" className="text-green-600 font-semibold hover:underline flex items-center gap-1">
                  Read more <span>→</span>
                </a>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="relative">
                <Image src="/images/c3.png" alt="Before After 3" width={400} height={300} className="w-full h-64 object-cover" />
                <div className="absolute bottom-0 left-0 right-0 flex justify-between text-white text-xs font-bold bg-gradient-to-t from-black/80 to-transparent px-3 py-1">
                  <span>BEFORE</span>
                  <span>AFTER</span>
                </div>
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-gray-900">Daniel’s Story</h3>
                <p className="text-gray-700 mb-3">“I viscerally needed to make me better.”</p>
                <a href="#" className="text-green-600 font-semibold hover:underline flex items-center gap-1">
                  Read more <span>→</span>
                </a>
              </div>
      ...
      {[
        {
          ...
          image: "/images/Screenshot 2025-09-27 225234.png",
        },
        {
          user: "chefheartandsoul",
          followers: "6.8k followers",
          image: "/images/Screenshot 2025-09-27 225240.png",
        },
        {
          user: "liftingcake",
          followers: "142.2k followers",
          image: "/images/Screenshot 2025-09-27 225247.png",
        },
        {
          user: "radiatewithemma",
          followers: "2.9k followers",
          image: "/images/Screenshot 2025-09-27 225252.png",
        },
        {
          user: "conteketo",
          followers: "36.2k followers",
          image: "/images/Screenshot 2025-09-27 225258.png",
        },
      ].map((review, idx) => (
        <div
          key={idx}
          className="flex-shrink-0 w-52 rounded-xl overflow-hidden shadow hover:scale-105 transition bg-white"
        >
          <Image
            src={review.image}
            alt={review.user}
    ...
    {[
      {
        name: "David H.",
        initials: "DH",
        product: "Base Exogenous Ketones",
        text: "Amazing product - absolutely love the taste and the extra energy it provides.",
      },
      {
        name: "Crystal L.",
        initials: "CL",
        product: "MCT Oil Powder",
        text: "This is so good. I put it in my coffee every morning. I love it!",
      },
      {
        name: "Karen W.",
        initials: "KW",
        product: "Keto Bars",
        text: "These bars are by far the best keto snack there is!",
      },
    ].map((t, idx) => (
      <div
        key={idx}
        className="flex flex-col items-start space-y-3 bg-white p-4 rounded-lg shadow"
      >
